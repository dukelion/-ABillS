...
# $version = '0.01';
# возращает перекодированную переменную, вызов win2koi(<переменная>)
...
# возращает перекодированную переменную, вызов win2iso(<переменная>)
sub win2iso {
...
# возращает перекодированную переменную, вызов win2dos(<переменная>)
sub win2dos {
