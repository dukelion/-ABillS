...
<tr><td rowspan=2>$_PAYMENTS</td><td>$_DATE ((>, <) YYYY-MM-DD):</td><td>%PAYMENTS%</td><TD class='even'>$_NUM:</TD><TD><input  tabindex='25' type=text name=PASPORT_NUM value='%PASPORT_NUM%'></TD></tr>
<tr><td>$_DAYS (>, <):</td><td><input  tabindex='15' type='text' name='PAYMENT_DAYS' value='%PAYMENT_DAYS%'/></td><TD class='even'>$_DATE:</TD><TD>%PASPORT_DATE%</TD></tr>
