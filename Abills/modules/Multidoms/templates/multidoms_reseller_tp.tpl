...
-->
  ...
  <input type=radio name=MONTH_TIME_TYPE value='0'> 30 $_MIN<br>
  <input type=radio name=MONTH_TIME_TYPE value='1'> $_HOURS: <input type=text name=HOURS value='%HOURS%' size=6><br>
  <input type=radio name=MONTH_TIME_TYPE value='2'> $_DAYS: <input type=text name=DAYS value='%DAYS%' size=6><br>
  </td></tr>
<!--
...
-->  
  <tr><td>$_TOTAL</td><td colspan=2><input type=text name=TOTAL_TRAF_LIMIT value='%TOTAL_TRAF_LIMIT%'></td></tr>
